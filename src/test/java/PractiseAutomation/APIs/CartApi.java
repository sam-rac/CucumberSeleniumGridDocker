...
import PractiseAutomation.Constants.APP_ENDPOINT;
import PractiseAutomation.Constants.EndPoint;
...
public class CartApi {
    ...
    public Response addToCart(int productId, int quantity){
        ...
        Response response = ApiRequests.post(APP_ENDPOINT.ADD_TO_CART.url, headers, formParams, cookies);
